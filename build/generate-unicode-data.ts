...
const sourceURL = join(rootDir, `../node_modules/${packageName}`);
...
const loadPropertyAliases = async (): Promise<void> => {
    let propertyAliasesContent = await readFile(join(rootDir, "PropertyValueAliases.txt"), "utf8");
...
const targetPath = join(rootDir, "../src/generated/UnicodeData.ts");
