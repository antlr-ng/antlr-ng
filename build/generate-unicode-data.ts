...
const dataPath = join(sourceURL, `../node_modules/${packageName}`);
...
const loadPropertyAliases = async (): Promise<void> => {
    let propertyAliasesContent = await readFile(join(sourceURL, "PropertyValueAliases.txt"), "utf8");
...
const targetPath = join(sourceURL, "../src/generated/UnicodeData.ts");
